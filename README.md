# Juniper Flats Pool & Spa — website

The website for Juniper Flats Pool & Spa. Plain HTML/CSS/JS with no build step: every file
here is served exactly as it is, by Cloudflare Pages, at https://demo-service.pages.dev/.
